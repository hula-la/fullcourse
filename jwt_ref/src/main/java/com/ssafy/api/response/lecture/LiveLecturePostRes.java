...
@Getter
@Setter
@ApiModel("LiveLecturePostResponse")
public class LiveLecturePostRes extends BaseResponseBody {
    ...
    public static LiveLecturePostRes of(int insId,
                                        String lecThumb,
                                        String lecTitle,
                                        String lecContents,
                                        int lecPrice,
                                        ...
                                        int lecStudent,
                                        int lecLimit) {
        LiveLecturePostRes res = new LiveLecturePostRes();
        res.setInsId(insId);
