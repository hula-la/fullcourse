...
import com.ssafy.fullcourse.domain.review.application.ActivityReviewService;
...
//    }
    ...
    public ResponseEntity<BaseResponseBody> registerReview(@PathVariable String type,@PathVariable Long placeId, @RequestBody ReviewPostReq reviewPostReq) {
    ...
    public ResponseEntity<BaseResponseBody> findReview(@PathVariable String type,@PathVariable Long placeId,Pageable pageable) {
    ...
    public ResponseEntity<BaseResponseBody> deleteReview(@PathVariable String type, Long reviewId) {
